...
const createUserSchema = z.object({
    ...
    loginAttempts: z.number().int().optional().default(0),
});
...
export const userRouter = createTRPCRouter({
        ...
        .mutation(async ({ input }) => {
            try {
                ...
                const userData = {
                    ...
                    twoFactorSecret: input.twoFactorSecret || null,
    ...
    changePassword: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            ...
            try {
                await userService.changePassword(input.id, input.currentPassword, input.newPassword);
    ...
    enableTwoFactor: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            try {
                return await userService.enableTwoFactor(input.id);
            } catch (error) {
                throw new TRPCError({
                    code: 'BAD_REQUEST',
    ...
    verifyTwoFactor: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            try {
                return await userService.verifyTwoFactor(input.id, input.token);
            } catch (error) {
                throw new TRPCError({
                    code: 'BAD_REQUEST',
    ...
    disableTwoFactor: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            try {
                return await userService.disableTwoFactor(input.id, input.token);
            } catch (error) {
                throw new TRPCError({
                    code: 'BAD_REQUEST',
    ...
    bulkUpdate: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            try {
                return await userService.bulkUpdateUsers(input.userIds, input.updateData);
            } catch (error) {
                throw new TRPCError({
                    code: 'BAD_REQUEST',
    ...
    bulkDelete: protectedProcedure
        ...
        .mutation(async ({ input }) => {
            try {
                ...
                throw new TRPCError({
                    code: 'BAD_REQUEST',
                    message: error instanceof Error ? error.message : 'Failed to bulk delete users',
                });
            }
        }),
